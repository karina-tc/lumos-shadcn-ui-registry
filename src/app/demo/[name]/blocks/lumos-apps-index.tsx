...
export default function LumosAppsIndex() {
  ...
  const filters = [
    { label: "App Name", operator: "is", type: "text" },
    { label: "App Status", operator: null, type: "checkboxes", options: ["Approved", "Blocklisted", "Deprecated", "Discovered", "In review", "Needs review"] },
    { label: "App Admin", operator: "is any of", type: "select" },
    { label: "Managed Accounts", operator: "=", type: "text" },
    { label: "Category", operator: "is any of", type: "select" },
    { label: "Sources", operator: "is any of", type: "select" },
    { label: "SmahtAI", operator: "is any of", type: "select" },
  ];
