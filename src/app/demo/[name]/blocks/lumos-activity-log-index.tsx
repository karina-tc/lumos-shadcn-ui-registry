export default function LumosActivityLogIndex() {
  const navSections = [
    ...
    },
    {
      label: "Workspace",
      items: [
        { label: "Activity Log", href: "#", active: true },
    ...
    <div className="flex h-screen bg-background">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <header className="flex h-12 items-center gap-4 border-b border-border bg-background px-6">
          <h1 className="text-sm font-medium text-foreground">Activity Log</h1>
        </header>
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Audit trail of all admin actions across your workspace
              </p>
            </div>
